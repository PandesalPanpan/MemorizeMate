...
import { forecastDueCounts } from '../stats/forecast';
      ...
      <div className={styles.forecast}>
        ...
        <div className={styles.forecastToggle}>
          {[7, 14, 30].map((n) => (
            <button
              key={n}
              className={forecastDays === n ? styles.forecastActive : styles.forecastBtn}
        ...
        <ForecastChart data={forecastDueCounts(cards, forecastDays)} />
      </div>
